...
namespace CompanyApplication.Controllers
{
    public class DesignationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Designation1")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Designation1")] Designation designation)
        {
            if (ModelState.IsValid)
            {
